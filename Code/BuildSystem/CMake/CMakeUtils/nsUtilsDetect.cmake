...
function(ns_detect_platform)
	...
	elseif(CMAKE_SYSTEM_NAME STREQUAL "Prospero" OR CMAKE_GENERATOR_PLATFORM STREQUAL "Prospero")
		# NOTE: CMake will use PS5's Clang Compiler. This will force every target to use the compiler.
		# Not sure if it will create problems, but it is best if there is a option to use the prospero compiler or msvc(tools)
		ns_check_allowed_access()
		message(STATUS "Platform is Playstation 5 (NS_CMAKE_PLATFORM_PLAYSTATION_5, NS_CMAKE_PLATFORM_CONSOLE)")
		set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_CONSOLE ON)
		set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_PLAYSTATION_5 ON)
		set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_PREFIX "PS5")
		# Set CMAKE Toolchain, this may mess with vcpkg, but it shouldnt work with PS5 in the firstplace.
		set(CMAKE_TOOLCHAIN_FILE "${SCE_CMAKE_DIR}PS5Clang.bat")
		# NOTE: Lets force the windows platforms off. when generating, it defines both platform flags, and that fucks up compiling.
		set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_WINDOWS OFF)
		set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_WINDOWS_DESKTOP OFF)
...
function(ns_detect_generator)
	...
	set_property(GLOBAL PROPERTY NS_CMAKE_GENERATOR_CLANG_PROSPERO OFF)
	...
	elseif(NS_CMAKE_PLATFORM_PLAYSTATION_5 OR CMAKE_GENERATOR_PLATFORM STREQUAL "Prospero")	# NOTE: PS5 should ONLY use its compiler.
		if (CMAKE_GENERATOR MATCHES "Visual Studio")
				...
				set_property(GLOBAL PROPERTY NS_CMAKE_GENERATOR_PREFIX "PS5CL")
				set_property(GLOBAL PROPERTY NS_CMAKE_GENERATOR_CONFIGURATION ${CMAKE_BUILD_TYPE})
...
macro(ns_pull_generator_vars)
	...
	get_property(NS_CMAKE_GENERATOR_CLANG_PROSPERO GLOBAL PROPERTY NS_CMAKE_GENERATOR_CLANG_PROSPERO)
...
function(ns_detect_compiler_and_architecture)
	...
	set_property(GLOBAL PROPERTY NS_CMAKE_COMPILER_PROSPERO_CLANG OFF)
	...
	if(NS_DETECTED_COMPILER STREQUAL "msvc") # Visual Studio Compiler
		...
		#endif()
			#else()
			#message(STATUS "Compiler is Prospero Clang (NS_CMAKE_COMPILER_CLANG_PROSPERO)")
			#set_property(GLOBAL PROPERTY NS_CMAKE_COMPILER_CLANG_PROSPERO ON)
		endif()
	...
	elseif(NS_DETECTED_COMPILER STREQUAL "ps5cl")
		message(STATUS "Compiler is Prospero Clang (NS_CMAKE_COMPILER_CLANG_PROSPERO)")
		set_property(GLOBAL PROPERTY NS_CMAKE_COMPILER_CLANG_PROSPERO ON)
	...
	set_property(GLOBAL PROPERTY NS_CMAKE_ARCHITECHTURE_PROSPERO OFF)
	...
	elseif(NS_DETECTED_ARCH STREQUAL "emscripten")
		...
		# Check if Playstation 5 is enabled. if so, then we are using prospero.
		if(${NS_CMAKE_PLATFORM_PLAYSTATION_5})
			message(STATUS "Architecture is Prospero (NS_CMAKE_ARCHITECHTURE_PROSPERO)")
			set_property(GLOBAL PROPERTY NS_CMAKE_ARCHITECHURE_PROSPERO ON)
		endif()
...
macro(ns_pull_compiler_and_architecture_vars)
	...
	get_property(NS_CMAKE_COMPILER_CLANG_PROSPERO GLOBAL PROPERTY NS_CMAKE_COMPILER_CLANG_PROSPERO)
	get_property(NS_CMAKE_COMPILER_GCC GLOBAL PROPERTY NS_CMAKE_COMPILER_GCC)

	get_property(NS_CMAKE_ARCHITECHURE_PROSPERO GLOBAL PROPERTY NS_CMAKE_ARCHITECHURE_PROSPERO)
