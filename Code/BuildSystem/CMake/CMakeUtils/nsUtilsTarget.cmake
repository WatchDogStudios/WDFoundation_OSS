...
macro(ns_create_target TYPE TARGET_NAME)
	if(NOT NS_CMAKE_PLATFORM_PLAYSTATION_5)
		...
		set(ARG_OPTIONS NO_PCH NO_UNITY NO_QT NO_NS_PREFIX ENABLE_RTTI NO_WARNINGS_AS_ERRORS NO_CONTROLFLOWGUARD ALL_SYMBOLS_VISIBLE NO_DEBUG)
		...
		if((${TYPE} STREQUAL "LIBRARY") OR(${TYPE} STREQUAL "STATIC_LIBRARY") OR(${TYPE} STREQUAL "SHARED_LIBRARY"))
			...
			ns_set_library_properties(${TARGET_NAME})
		...
		elseif(${TYPE} STREQUAL "APPLICATION")
			...
			ns_set_application_properties(${TARGET_NAME})
		...
		if(NOT ${ARG_NO_PCH} OR NS_CMAKE_PLATFORM_PLAYSTATION_5)
		...
		if(NS_COMPILE_ENGINE_AS_DLL AND NS_CMAKE_PLATFORM_LINUX AND NOT ARG_ALL_SYMBOLS_VISIBLE AND NS_CMAKE_PLATFORM_PLAYSTATION_5)
		...
		ns_create_prospero_target(${TYPE} ${TARGET_NAME} NO_UNITY)
	endif()
endmacro()