...
// char * strncpy(_Out_cap_(_Count) _Post_maybns_ char * _Dest, _In_z_ const char * _Source, _In_ size_t _Count)
// buffer maybe zero-terminated after the call
#define _Post_maybns_ _SAL1_1_Source_(_Post_maybns_, (), _Post1_impl_(__maybezterm_impl))
