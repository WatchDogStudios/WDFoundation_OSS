...
namespace nsUwpTestHarness
{
  ...
  class Program
  {
    public class Options
    {
      ...
      public string nsWorkspace { get; set; }
    ...
    static void Main(string[] args)
    {
      ...
      AppDomain.CurrentDomain.UnhandledException += (object sender, UnhandledExceptionEventArgs eventArgs) =>
      {
        ...
        try
        {
          ...
          var bla = nsProcessHelper.RunExternalExe("procdump", args2, absBinDir);
        }
        catch (Exception e)
        {
      ...
      Parser.Default.ParseArguments<Options>(args)
        ...
        {
          nsTestUWP test = new nsTestUWP(o.nsWorkspace, o.testOutputPath, o.configuration, o.platform, o.project);
          test.ExecuteTest();
        });
    }
