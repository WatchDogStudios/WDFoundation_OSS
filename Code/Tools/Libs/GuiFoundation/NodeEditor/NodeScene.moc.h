...
private:
  ...
  void CreateQtComment(const nsDocumentObject* pObject);
  void DeleteQtComment(const nsDocumentObject* pObject);
...
protected:
  ...
  virtual void CreateCommentGroupAction(const nsDocumentObject* nodes, const nsVec2& vPos, const nsVec2& vSize);
...
private:
  ...
  static nsRttiMappedObjectFactory<nsQtCommentNode> s_CommentFactory;
...
protected:
  ...
  nsMap<const nsDocumentObject*, nsQtCommentNode*> m_Comments;
private:
