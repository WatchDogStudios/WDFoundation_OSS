#pragma once
/// \file
/// NOTE: THIS IS NOT ALLOWED TO BE INCLUDED IN THE OPEN-SOURCE VERSION. CONSOLE SPECIFIC MACROS ARE REMOVED.
/// *** Example Platform Subsystem declarations ***
///
/// NS_BEGIN_PLATFORM_SUBSYSTEM_DECLARATION(Foundation, ExampleSubSystem)
///
...
///  }
///
/// NS_END_PLATFORM_SUBSYSTEM_DECLARATION;
...
#define NS_BEGIN_PLATFORM_SUBSYSTEM_DECLARATION(GroupName, SubsystemName) \
...
#define NS_END_PLATFORM_SUBSYSTEM_DECLARATION \
  }                                  \
...
#define BEGIN_PLATFORM_SUBSYSTEM_DEPENDENCIES                        \
public:                                                     \
...
#define END_PLATFORM_SUBSYSTEM_DEPENDENCIES \
  , nullptr                        \
  }                                \
  ;                                \
  return szDeps[iDep];             \
...
#define NS_MAKE_PLATFORM_SUBSYSTEM_STARTUP_FRIEND(GroupName, SubsystemName) friend class GroupName##SubsystemName##SubSystem;