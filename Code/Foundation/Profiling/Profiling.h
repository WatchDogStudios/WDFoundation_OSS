...
#  define NS_PROFILE_SCOPE(szScopeName) nsProfilingScope NS_CONCAT(_nsProfilingScope, NS_SOURCE_LINE)(szScopeName, NS_SOURCE_FUNCTION, nsTime::MakeZero())
...
#  define NS_PROFILE_LIST_SCOPE(szListName, szFirstSectionName) \
    nsProfilingListScope NS_CONCAT(_nsProfilingScope, NS_SOURCE_LINE)(szListName, szFirstSectionName, NS_SOURCE_FUNCTION)
