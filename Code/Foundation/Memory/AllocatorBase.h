...
class NS_FOUNDATION_DLL nsAllocatorBase
{
public:
  struct Stats
  {
  ...
  /// See nsMemoryTrackingFlags::EnableAllocationTracking and NS_USE_ALLOCATION_TRACKING.
...
private:
  NS_DISALLOW_COPY_AND_ASSIGN(nsAllocatorBase);
};
