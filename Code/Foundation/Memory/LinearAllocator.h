...
template <nsAllocatorTrackingMode TrackingMode = nsAllocatorTrackingMode::Default>
class nsLinearAllocator : public nsAllocatorWithPolicy<nsAllocPolicyStack, TrackingMode>
{
public:
