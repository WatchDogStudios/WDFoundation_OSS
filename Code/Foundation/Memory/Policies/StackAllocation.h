...
namespace nsMemoryPolicies
{
  ...
  public:
    ...
    NS_FORCE_INLINE nsStackAllocation(nsAllocatorBase* pParent)
      : m_pParent(pParent)
      , m_uiNextBucketSize(4096)
    {
    }

    NS_FORCE_INLINE ~nsStackAllocation()
    {
    ...
    NS_FORCE_INLINE void FillStats(nsAllocatorBase::Stats& ref_stats)
    {
  ...
  private:
    nsAllocatorBase* m_pParent = nullptr;
